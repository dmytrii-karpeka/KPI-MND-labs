...
def experiment(m):
    ...
    matrix_y = [[x1_min_norm, x2_min_norm] + matrix_y[0],
                [x1_max_norm, x2_min_norm] + matrix_y[1],
                [x1_min_norm, x2_max_norm] + matrix_y[2]]
    ...
    def criteria(r1, r2, r3, probability, m=m):
        ...
        if r1 < rkr and r2 < rkr and r3 < rkr:
            ...
            print("Дисперсія неоднорідна. Збільшимо m на 2")
            m = m+2
            experiment(m)
